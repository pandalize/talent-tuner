  ...
  <div id="app">
    <header class="app-header">
      ...
      <nav class="header-nav">
          ...
          <NuxtLink to="/diagnosis" class="nav-item">{{ $t('nav.diagnosis') }}</NuxtLink>
          <NuxtLink to="/newchat" class="nav-item">{{ $t('nav.newchat') }}</NuxtLink>
    ...
    <div class="footer-content">
      ...
      <div class="footer-section">
        ...
        <ul>
          ...
          <li><NuxtLink to="/chat">AI進路相談</NuxtLink></li>
          <li><NuxtLink to="/about">職業一覧</NuxtLink></li>
          <li><NuxtLink to="/career-guide">キャリアガイド</NuxtLink></li>
          <li><NuxtLink to="/diagnosis-method">診断方法</NuxtLink></li>
        </ul>
      </div>
      ...
      <div class="footer-section">
        ...
        <ul>
          ...
          <li><NuxtLink to="/company">運営者情報</NuxtLink></li>
      ...
      <div class="footer-section">
        ...
        <ul>
          ...
          <li><NuxtLink to="/terms">利用規約</NuxtLink></li>
        </ul>
      </div>
    </div>
